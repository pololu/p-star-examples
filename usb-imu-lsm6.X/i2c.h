...
// Performs a series of transfers to I2C devices.  The argument should point to
// an array of transfers where the last transfer is indicated with I2C_FLAG_STOP
// in its flags field.  If there are multiple transfers, this function uses I2C
